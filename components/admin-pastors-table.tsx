  ...
  return (
    <div>
      ...
      <div className="mb-4 flex flex-wrap gap-2 print:hidden">
        ...
        <span className="self-center text-sm text-ink/40">
                ...
                <tbody className="divide-y divide-ink/5">
                  {profiles.map((p, i) => (
                    <tr key={p.id} className="transition-colors hover:bg-mist/30">
                      <td className="px-4 py-3 font-mono text-sm font-semibold text-ink/40">
                        {padNumber(i + 1)}
                      </td>
            ...
            {profiles.map((p, i) => (
              <div key={p.id} className="rounded-xl border border-ink/10 bg-white p-4 shadow-soft">
                <div className="flex items-start justify-between gap-2">
                  <div>
                    <p className="text-xs font-mono font-semibold text-ink/40 mb-0.5">{padNumber(i + 1)}</p>
